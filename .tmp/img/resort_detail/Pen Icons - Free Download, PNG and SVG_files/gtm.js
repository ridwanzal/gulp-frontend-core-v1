...
return null},$c=!1;if(H.querySelectorAll)try{var ad=H.querySelectorAll(":root");ad&&1==ad.length&&ad[0]==H.documentElement&&($c=!0)}catch(a){}var Xc=$c;var od={},K=null,pd=Math.random();od.s="GTM-5W9QXH7";od.Pb="7v1";od.Pd="";var qd={__cl:!0,__ecl:!0,__ehl:!0,__evl:!0,__fal:!0,__fil:!0,__fsl:!0,__hl:!0,__jel:!0,__lcl:!0,__sdl:!0,__tl:!0,__ytl:!0,__paused:!0,__tg:!0},ud="www.googletagmanager.com/gtm.js";
var vd=ud,wd=null,xd=null,yd="//www.googletagmanager.com/a?id="+od.s+"&cv=172",zd={},Ad={},Bd=function(){var a=K.sequence||1;K.sequence=a+1;return a};
...
"."+d:"&epr="+d;Fd();2022<=Nd().length&&Ed()}};var Yd={},Zd=new za,$d={},ae={},de={name:"GTMDataLayer",set:function(a,b){n(Ma(a,b),$d);be()},get:function(a){return ce(a,2)},reset:function(){Zd=new za;$d={};be()}},ce=function(a,b){if(2!=b){var c=Zd.get(a);Td&&c!==ee(a.split("."))&&E(5);return c}return ee(a.split("."))},ee=function(a){for(var b=$d,c=0;c<a.length;c++){if(null===b)return!1;if(void 0===b)break;b=b[a[c]]}return b},fe=function(a,b){ae.hasOwnProperty(a)||(Zd.set(a,b),n(Ma(a,b),$d),be())},be=function(a){Ba(ae,function(b,c){Zd.set(b,c);
...
return!a}function tk(){var a=sk();try{Mj(G["GTMDataLayer"],od.s)}catch(b){}return a}
var vk=function(){var a=mc("GTMDataLayer",[]),b=mc("google_tag_manager",{});b=b["GTMDataLayer"]=b["GTMDataLayer"]||{};Kg(function(){b.gtmDom||(b.gtmDom=!0,a.push({event:"gtm.dom"}))});Sj(function(){b.gtmLoad||(b.gtmLoad=!0,a.push({event:"gtm.load"}))});b.subscribers=(b.subscribers||0)+1;var c=a.push;a.push=function(){var e;if(0<K.SANDBOXED_JS_SEMAPHORE){e=[];for(var f=0;f<arguments.length;f++)e[f]=new jk(arguments[f])}else e=[].slice.call(arguments,0);var h=c.apply(a,e);kk.push.apply(kk,e);if(300<
...
f))}if(void 0!==f&&0>=f)return!0;(d=d.parentElement)&&(e=G.getComputedStyle(d,null))}return!1};var fl=G.clearTimeout,gl=G.setTimeout,T=function(a,b,c){if(fg()){b&&I(b)}else return oc(a,b,c)},hl=function(){return new Date},il=function(){return G.location.href},jl=function(a){return pe(re(a),"fragment")},kl=function(a){return qe(re(a))},ll=function(a,b){return ce(a,b||2)},ml=function(a,b,c){var d;b?(a.eventCallback=b,c&&(a.eventTimeout=c),d=mk(a)):d=mk(a);return d},nl=function(a,b){G[a]=b},W=function(a,b,c){b&&
(void 0===G[a]||c&&!G[a])&&(G[a]=b);return G[a]},ol=function(a,b,c){return ve(a,b,void 0===c?!0:!!c)},pl=function(a,b,c){return 0===Ee(a,b,c)},ql=function(a,b){if(fg()){b&&I(b)}else qc(a,b)},rl=function(a){return!!Dk(a,"init",!1)},sl=function(a){Bk(a,"init",!0)},tl=function(a,b){var c=(void 0===b?0:b)?"www.googletagmanager.com/gtag/js":vd;c+="?id="+encodeURIComponent(a)+"&l=GTMDataLayer";T(O("https://","http://",c))},ul=function(a,
...
Z.a.sdl=["google"],function(){function a(){return!!(Object.keys(l("horiz.pix")).length||Object.keys(l("horiz.pct")).length||Object.keys(l("vert.pix")).length||Object.keys(l("vert.pct")).length)}function b(x){for(var A=[],B=x.split(","),z=0;z<B.length;z++){var D=Number(B[z]);if(isNaN(D))return[];m.test(B[z])||A.push(D)}return A}function c(){var x=0,A=0;return function(){var B=Wk(),z=B.height;x=Math.max(v.scrollLeft+B.width,x);A=Math.max(v.scrollTop+z,A);return{qg:x,rg:A}}}function d(){q=W("self");
u=q.document;v=u.scrollingElement||u.body&&u.body.parentNode;y=c()}function e(x,A,B,z){var D=l(A),F={},L;for(L in D){F.Ha=L;if(D.hasOwnProperty(F.Ha)){var P=Number(F.Ha);x<P||(ml({event:"gtm.scrollDepth","gtm.scrollThreshold":P,"gtm.scrollUnits":B.toLowerCase(),"gtm.scrollDirection":z,"gtm.triggers":D[F.Ha].join(",")}),Ck("sdl",A,function(Q){return function(N){delete N[Q.Ha];return N}}(F),{}))}F={Ha:F.Ha}}}function f(){var x=y(),A=x.qg,B=x.rg,z=A/v.scrollWidth*100,D=B/v.scrollHeight*100;e(A,"horiz.pix",
r.Nb,t.Ld);e(z,"horiz.pct",r.Mb,t.Ld);e(B,"vert.pix",r.Nb,t.ee);e(D,"vert.pct",r.Mb,t.ee);Bk("sdl","pending",!1)}function h(){var x=250,A=!1;u.scrollingElement&&u.documentElement&&q.addEventListener&&(x=50,A=!0);var B=0,z=!1,D=function(){z?B=gl(D,x):(B=0,f(),rl("sdl")&&!a()&&(tc(q,"scroll",F),tc(q,"resize",F),Bk("sdl","init",!1)));z=!1},F=function(){A&&y();B?z=!0:(B=gl(D,x),Bk("sdl","pending",!0))};return F}function k(x,A,B){if(A){var z=b(String(x));Ck("sdl",B,function(D){for(var F=0;F<z.length;F++){var L=
String(z[F]);D.hasOwnProperty(L)||(D[L]=[]);D[L].push(A)}return D},{})}}function l(x){return Dk("sdl",x,{})}function p(x){I(x.vtp_gtmOnSuccess);var A=x.vtp_uniqueTriggerId,B=x.vtp_horizontalThresholdsPixels,z=x.vtp_horizontalThresholdsPercent,D=x.vtp_verticalThresholdUnits,F=x.vtp_verticalThresholdsPixels,L=x.vtp_verticalThresholdsPercent;switch(x.vtp_horizontalThresholdUnits){case r.Nb:k(B,A,"horiz.pix");break;case r.Mb:k(z,A,"horiz.pct")}switch(D){case r.Nb:k(F,A,"vert.pix");break;case r.Mb:k(L,
A,"vert.pct")}rl("sdl")?Dk("sdl","pending")||(w||(d(),w=!0),I(function(){return f()})):(d(),w=!0,v&&(sl("sdl"),Bk("sdl","pending",!0),I(function(){f();if(a()){var P=h();sc(q,"scroll",P);sc(q,"resize",P)}else Bk("sdl","init",!1)})))}var m=/^\s*$/,r={Mb:"PERCENT",Nb:"PIXELS"},t={ee:"vertical",Ld:"horizontal"},q,u,v,w=!1,y;(function(x){Z.__sdl=x;Z.__sdl.b="sdl";Z.__sdl.g=!0;Z.__sdl.priorityOverride=0})(function(x){x.vtp_triggerStartOption?p(x):Sj(function(){p(x)})})}();
...
Z.a.hl=["google"],function(){function a(f){return f.target&&f.target.location&&f.target.location.href?f.target.location.href:il()}function b(f,h){sc(f,"hashchange",function(k){var l=a(k);h({source:"hashchange",state:null,url:kl(l),O:jl(l)})})}function c(f,h){sc(f,"popstate",function(k){var l=a(k);h({source:"popstate",state:k.state,url:kl(l),O:jl(l)})})}function d(f,h,k){var l=h.history,p=l[f];if(ra(p))try{l[f]=function(m,r,t){p.apply(l,[].slice.call(arguments,0));k({source:f,state:m,url:kl(il()),
O:jl(il())})}}catch(m){}}function e(){var f={source:null,state:W("history").state||null,url:kl(il()),O:jl(il())};return function(h){var k=f,l={};l[k.source]=!0;l[h.source]=!0;if(!l.popstate||!l.hashchange||k.O!=h.O){var p={event:"gtm.historyChange","gtm.historyChangeSource":h.source,"gtm.oldUrlFragment":f.O,"gtm.newUrlFragment":h.O,"gtm.oldHistoryState":f.state,"gtm.newHistoryState":h.state,"gtm.oldUrl":f.url,"gtm.newUrl":h.url};f=h;ml(p)}}}(function(f){Z.__hl=f;Z.__hl.b="hl";Z.__hl.g=!0;Z.__hl.priorityOverride=
0})(function(f){var h=W("self");if(!rl("hl")){var k=e();b(h,k);c(h,k);d("pushState",h,k);d("replaceState",h,k);sl("hl")}I(f.vtp_gtmOnSuccess)})}();
